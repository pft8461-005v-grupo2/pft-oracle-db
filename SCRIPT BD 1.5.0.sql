...
ALTER TABLE detalle_subasta
    ADD CONSTRAINT det_sub_transa_fk FOREIGN KEY ( transportista_id )
...
ALTER TABLE proceso_venta_ingreso
    ADD CONSTRAINT pr_vta_ing_ing_fk FOREIGN KEY ( ingreso_id )
        REFERENCES ingreso ( id );

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE proceso_venta_ingreso
    ADD CONSTRAINT pr_vta_ing_pr_vta_fk FOREIGN KEY ( proceso_venta_id )

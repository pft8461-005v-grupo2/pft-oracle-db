...
ALTER TABLE detalle_subasta
    ADD CONSTRAINT detalle_subasta_trans_fk FOREIGN KEY ( transportista_id )
...
ALTER TABLE proceso_venta_ingreso
    ADD CONSTRAINT proc_venta_ingreso_fk FOREIGN KEY ( ingreso_id )
        REFERENCES ingreso ( id );

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE proceso_venta_ingreso
    ADD CONSTRAINT proc_venta_ing_proc_venta_fk FOREIGN KEY ( proceso_venta_id )
        REFERENCES proceso_venta ( id );

--  ERROR: FK name length exceeds maximum allowed length(30) 
ALTER TABLE proceso_venta
    ADD CONSTRAINT proc_venta_soli_compra_fk FOREIGN KEY ( solicitud_compra_id )

...
ALTER TABLE detalle_subasta ADD CONSTRAINT detalle_subasta_pk PRIMARY KEY ( transportista_id, subasta_id );
...
CREATE TABLE proceso_venta (
    ...
    fechacreacion         DATE NOT NULL,
    clienteaceptaacuerdo  CHAR(1) NOT NULL,
...
ALTER TABLE detalle_subasta
    ADD CONSTRAINT det_subasta_transpor_fk FOREIGN KEY ( transportista_id )
...
ALTER TABLE proceso_venta
    ADD CONSTRAINT proces_venta_sol_compra_fk FOREIGN KEY ( solicitud_compra_id )
        REFERENCES solicitud_compra ( id );
...
ALTER TABLE productor
    ADD CONSTRAINT productor_contrato_fk FOREIGN KEY ( contrato_id )
